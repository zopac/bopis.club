...
public
class GuiConfig extends GuiScreen {
    private final ChatSettings settings;
    private final List < ITextComponent > exampleChat = new ArrayList <> ( );
...
//                this.mc.gameSettings.chatWidth = 1.0f;
    ...
    private
    String getColoredBool ( String prop , boolean bool ) {
        if ( bool ) {
    ...
    private
    String getPropName ( String prop ) {
