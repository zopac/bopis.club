package me.lord.bopis.features.gui.components;

import me.lord.bopis.Bopis;
import me.lord.bopis.features.Feature;
import me.lord.bopis.features.gui.OyVeyGui;
import me.lord.bopis.features.gui.components.items.Item;
import me.lord.bopis.features.gui.components.items.buttons.Button;
import me.lord.bopis.features.modules.client.ClickGui;
import me.lord.bopis.util.ColorUtil;
...
public class Component
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Bopis.textManager.drawStringWithShadow(this.getName(), (float) this.x + 3.0f, (float) this.y - 4.0f - (float) OyVeyGui.getClickGui().getTextOffset(), -1);
        if (this.open) {
