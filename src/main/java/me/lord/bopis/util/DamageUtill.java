...
public class DamageUtill
    ...
    public static float calculateDamage(double posX, double posY, double posZ, Entity entity) {
        ...
        if (entity instanceof EntityLivingBase) {
            finald = DamageUtill.getBlastReduction((EntityLivingBase) entity, DamageUtill.getDamageMultiplied(damage), new Explosion( mc.world, null, posX, posY, posZ, 6.0f, false, true));
        }
        return (float) finald;
    }
