...
public class ESP
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        if (this.items.getValue().booleanValue()) {
            ...
            for (Entity entity : ESP.mc.world.loadedEntityList) {
                ...
                RenderGlobal.renderFilledBox(bb, this.colorSync.getValue() != false ? (float) ClickGui.getInstance().getCurrentColor().getRed() / 255.0f : (float) this.red.getValue().intValue() / 255.0f, this.colorSync.getValue() != false ? (float) ClickGui.getInstance().getCurrentColor().getGreen() / 255.0f : (float) this.green.getValue().intValue() / 255.0f, this.colorSync.getValue() != false ? (float) ClickGui.getInstance().getCurrentColor().getBlue() / 255.0f : (float) this.blue.getValue().intValue() / 255.0f, this.colorSync.getValue() != false ? (float) ClickGui.getInstance().getCurrentColor().getAlpha() : (float) this.boxAlpha.getValue().intValue() / 255.0f);
                GL11.glDisable(2848);
        ...
        if (this.xporbs.getValue().booleanValue()) {
            ...
            for (Entity entity : ESP.mc.world.loadedEntityList) {
                ...
                GL11.glHint(3154, 4354);
                GL11.glLineWidth(1.0f);
                RenderGlobal.renderFilledBox(bb, this.colorSync.getValue() != false ? (float) ClickGui.getInstance().getCurrentColor().getRed() / 255.0f : (float) this.red.getValue().intValue() / 255.0f, this.colorSync.getValue() != false ? (float) ClickGui.getInstance().getCurrentColor().getGreen() / 255.0f : (float) this.green.getValue().intValue() / 255.0f, this.colorSync.getValue() != false ? (float) ClickGui.getInstance().getCurrentColor().getBlue() / 255.0f : (float) this.blue.getValue().intValue() / 255.0f, this.colorSync.getValue() != false ? (float) ClickGui.getInstance().getCurrentColor().getAlpha() / 255.0f : (float) this.boxAlpha.getValue().intValue() / 255.0f);
                GL11.glDisable(2848);
                GlStateManager.depthMask(true);
                GlStateManager.enableDepth();
                GlStateManager.enableTexture2D();
    ...
    public void onRenderModel(RenderEntityModelEvent event) {
        ...
        if (!(!this.onTop.getValue().booleanValue() || Chams.getInstance().isEnabled())) {
