...
public class Skeleton
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        for (EntityPlayer player : Skeleton.mc.world.playerEntities) {
            ...
            this.renderSkeleton(player, this.rotationList.get(player), this.colorSync.getValue() != false ? ClickGui.getInstance().getCurrentColor() : EntityUtil.getColor((Entity)player, this.red.getValue(), this.green.getValue(), this.blue.getValue(), this.alpha.getValue(), this.colorFriends.getValue()));
        }
        RenderUtil.GlPost();
    }
