...
public class Colors extends Module {
    ...
    public Colors() {
        super("Colors", "nigga", Module.Category.CLIENT, true, false, false);
        INSTANCE = this;
    }
    ...
    public void onTick() {
        ...
        if (ClickGui.getInstance().colorSync.getValue().booleanValue()) {
            Bopis.colorManager.setColor(INSTANCE.getCurrentColor().getRed(), INSTANCE.getCurrentColor().getGreen(), INSTANCE.getCurrentColor().getBlue(), ClickGui.getInstance().hoverAlpha.getValue());
        }
    }
