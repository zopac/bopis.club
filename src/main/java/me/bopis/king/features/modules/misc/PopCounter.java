...
public class PopCounter extends Module {
    ...
    public void onDeath(EntityPlayer player) {
        if (TotemPopContainer.containsKey(player.getName())) {
            ...
            if (l_Count == 1) {
                Command.sendSilentMessage(ChatFormatting.RED + player.getName() + " died after popping " + ChatFormatting.GRAY + l_Count + ChatFormatting.RED + ChatFormatting.RED + " totem");
            } else {
    ...
    public void onTotemPop(EntityPlayer player) {
        ...
        if (l_Count == 1) {
            Command.sendSilentMessage(ChatFormatting.RED + player.getName() + " popped " + ChatFormatting.GRAY + l_Count + ChatFormatting.RED + " totem");
        } else {
